...
class Inventory(models.Model):
    ...
    def _get_inventory_lines_values(self):
        ...
        domain = ' sq.location_id in %s AND sq.quantity != 0 AND pp.active = TRUE'
        ...
        self.env.cr.execute("""SELECT sq.product_id as product_id, sum(quantity) as product_qty, sq.location_id as location_id, sq.lot_id as prod_lot_id,
            sq.package_id, sq.owner_id as partner_id
            FROM stock_quant sq
