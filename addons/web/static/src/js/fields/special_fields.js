...
var FieldTimezoneMismatch = FieldSelection.extend({
    ...
    _renderTimezoneMismatch: function () {
        ...
        if (this.mismatch){
            ...
            $span.attr('title', _t("Timezone Mismatch : The timezone of your browser doesn't match the selected one. The time in Takobi is displayed according to the timezone set on your user's preferences."));
